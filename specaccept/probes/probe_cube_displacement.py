...
THE TWO PROTOCOLS, both read from primary sources rather than inferred:
  ...
  (b) ours, specaccept/envs/cube/eval.py --start final:
...
thresholds at 0.04 m.
  ...
  python -m specaccept.probes.probe_cube_displacement --h5 <cube.h5> \
...
def main():
    ...
    results["protocols"] = {
        ...
        "ours": {"source": "specaccept/envs/cube/eval.py --start final",
