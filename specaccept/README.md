...
## Entry points
    ...
    python -m specaccept.train_drafter --subgoals <dense.pt> --out <ckpt.pt> ...
    python -m specaccept.envs.pusht.eval --subgoal {baseline,oracle,gdm,dspark,specaccept,regressor} ...
    python -m specaccept.envs.reacher.eval --subgoal {baseline,oracle,gdm,specaccept} ...
    python -m specaccept.probes.probe_suffix_decay --gdm-ckpt <ckpt.pt> ...
