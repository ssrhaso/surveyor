...
validated there.
  ...
  python -m surveyor.probes.learn_readout --name reacher \
      --subgoals-pt subgoals_reacher_dense.pt --hop-stride 10 --out readout_reacher.pt
  python -m surveyor.probes.learn_readout --name droid --attentive \
...
from surveyor.probes.gap_stat import sequences_from_glob, sequences_from_pt
