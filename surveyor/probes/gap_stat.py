...
of lat_*.npz|npy episode files (V-JEPA 2 tokens; pooled over the token axis).
  ...
  python -m surveyor.probes.gap_stat --name pusht --subgoals-pt subgoals_pusht.pt
  python -m surveyor.probes.gap_stat --name droid --lat-glob "droid_lat/lat_*.npz" --hop-stride 10
"""
