...
\addlegendentry{inverted, no operating $\tau$}
...
% inverted (dashed; drawn hop p10 -> equiv p90)
\addplot[gapdead, line width=3pt, densely dashed] coordinates {(1.018,6) (1.393,6)};
\addplot[gapdead, line width=3pt, densely dashed] coordinates {(0.076,5) (0.112,5)};
% taus
...
inverted at every stride (verification measurably cannot operate: even ground-truth
demo waypoints verify $14/113$); DROID's pooled space opens no gap at any stride,
and both prescribed repairs measured null there (\Cref{sec:generality-scale}).
